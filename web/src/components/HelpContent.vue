<template>
  <div class="help-content">
    ...
    <v-card>
      <v-card-title>常用表达式</v-card-title>
      <v-card-text>
        <v-table class="help-table">
          ...
          <tbody>
            <tr>
              <th><code>sdata.http_gzip:flag</code></th>
              <td>对服务端报文应用 <code>http_gzip</code> 转换器后查找包含 <code>flag</code> 的内容。</td>
            </tr>
            <tr>
              <th><code>sdata.b64decode:flag</code></th>
              <td>对服务端报文进行 Base64 解码后搜索 <code>flag</code>。</td>
            </tr>
            <tr>
              <th><code>time:"2025-10-27 140950:2025-10-27 140959"</code></th>
              <td>匹配任意报文时间在指定时间窗口（2025-10-27 14:09:50–14:09:59）的流量。</td>
            </tr>
          </tbody>
        </v-table>
      </v-card-text>
